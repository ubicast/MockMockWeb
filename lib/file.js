...
exports.serveTemplateWithBorder = function(response, contentPath, borderPath, context) {
  Fs.readFile(contentPath, {encoding: 'utf8'}, function(err, data) {
    if (err) {
      send404(response);
    }
    else {
      context.content = Ejs.render(data, {
        cache: false,
        filename: contentPath,
        locals: context
      });
      exports.serveTemplate(response, borderPath, context);
    }
  });
};
